...
def _non_module_deps_impl(ctx):
  ...
  http_file(
    ...
    sha256 = "d6fef1911be8815b7ea6a21ea9e7bd9d96485b6645b4262452b41444075fb303",
    url = "https://github.com/JasonSteving99/claro-lang/releases/download/v0.1.347/claro-cli-install.tar.gz",
  )
