...
def java_calculator_library(name, src, java_name = "CompiledCalculator", calculator_compiler_name = DEFAULT_CALCULATOR_NAME):
    native.genrule(
        ...
        tools = [
            "//src/java/com/claro/examples/calculator_example:calculator_compiler_binary_deploy.jar",
        ],
        outs = [java_name + ".java"]
    )
...
def gen_calculator_compiler(name = DEFAULT_CALCULATOR_NAME):
    ...
    native.java_library(
        ...
        deps = [
            ...
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions:expr",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions:expr_impls",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions/bool:bool_expr",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions/bool:bool_expr_impls",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions/numeric:numeric_expr_impls",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions/procedures",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions/term",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/expressions/term:term_impls",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/statements:stmt",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/statements:stmt_impls",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/statements:stmt_list_node",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/types:type",
            "//src/java/com/claro/examples/calculator_example/intermediate_representation/types:types",
            "//:apache_commons_text",
            "//:guava",
