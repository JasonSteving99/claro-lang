...
/**
 * This is a derivative of the ConsumerFunctionCallStmt that exists solely to handle calls to functions that are certainly not
 ...
 * arbitrary Expr.
 */
public class FirstClassConsumerFunctionCallStmt extends Stmt {
  private final Expr functionExpr;
  public final ImmutableList<Expr> argExprs;

  public FirstClassConsumerFunctionCallStmt(Expr functionExpr, ImmutableList<Expr> args) {
  ...
  public void assertExpectedExprTypes(ScopedHeap scopedHeap) throws ClaroTypeException {
    ...
    if (((Types.ProcedureType) referencedIdentifierType).hasReturnValue()) {
      this.functionExpr.logTypeError(ClaroTypeException.forFunctionCallUsedAsStmt(referencedIdentifierType));
      return;
    }
    ImmutableList<Type> definedArgTypes = ((Types.ProcedureType.ConsumerType) referencedIdentifierType).getArgTypes();
