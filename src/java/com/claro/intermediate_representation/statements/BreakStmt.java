...
public class BreakStmt extends Stmt {
  ...
  public BreakStmt(Supplier<String> currenLineSupplier, int currentLineNumber, int startCol, int endCol) {
  ...
  public void assertExpectedExprTypes(ScopedHeap scopedHeap) throws ClaroTypeException {
    ...
    scopedHeap.initializeIdentifier("$BREAK");
  }

  @Override
  public GeneratedJavaSource generateJavaSourceOutput(ScopedHeap scopedHeap) {
    return GeneratedJavaSource.forJavaSourceBody(new StringBuilder("break;\n"));
  }

  @Override
  public Object generateInterpretedOutput(ScopedHeap scopedHeap) {
    // TODO(steving) Eventually need to impl break when I come back to adding support for the interpreted backend.
    throw new RuntimeException("Internal Compiler Error! Claro doesn't support `break` in the interpreted backend just yet!");
  }
}
