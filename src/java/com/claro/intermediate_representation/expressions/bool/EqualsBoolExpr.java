...
/**
 * DESIGN WARNING: DON'T FORGET THAT THE `==` OPERATOR IS USED BY CLARO TO DO TYPE NARROWING OF ONEOFS. AS A RESULT, IT
 * WOULD BE INVALID TO EVER ALLOW USERS TO OVERRIDE THE `==` OPERATOR BECAUSE THEY MAY INVALIDATE SOME OF THE INVARIANTS
 * THAT TYPE NARROWING DEPENDS ON. ALL OTHER OPERATORS SHOULD BE ABLE TO BE OVERRIDDEN, BUT I'LL TAKE A STRONG STANCE ON
 * THERE ONLY BEING A SINGLE DEFINITION OF "EQUALITY" IN THE LANGUAGE, AND I THINK THE LANGUAGE WILL BE BETTER OFF FOR IT.
 */
