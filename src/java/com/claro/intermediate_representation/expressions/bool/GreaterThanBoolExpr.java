...
public class GreaterThanBoolExpr extends BoolExpr {
  ...
  public GreaterThanBoolExpr(Expr lhs, Expr rhs, Supplier<String> currentLine, int currentLineNumber, int startCol, int endCol) {
  ...
  public Object generateInterpretedOutput(ScopedHeap scopedHeap) {
    ...
    if (lhs instanceof Double && rhs instanceof Double) {
      ...
      // TODO(steving) Comparable::greaterThan.
